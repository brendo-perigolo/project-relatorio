...
export const treinamentoGerencial = [
...
export const treinamentoCheff = [
  { id: "check32", label: "Cadastro de produto.", checked: false },
  { id: "check33", label: "Cadastro e inclusao de Observaçöes.", checked: false },
  { id: "check34", label: "Importaçao de produto.", checked: false },
  { id: "check35", label: "Inclusao de Categorias.", checked: false },
  { id: "check36", label: "Mapa de produtos.", checked: false },
